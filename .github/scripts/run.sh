...
LTC_TS_CUDA=1 python $HOME/pytorch/lazy_tensor_core/lazy_bench.py -d cuda --repeat 1 --warmup 1 --fuser noopt --output_dir ${DATA_DIR} --test train --torchbench_dir .
LTC_TS_CUDA=1 python $HOME/pytorch/lazy_tensor_core/lazy_bench.py -d cuda --repeat 1 --warmup 1 --fuser noopt --output_dir ${DATA_DIR} --test eval --torchbench_dir .
